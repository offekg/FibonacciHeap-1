...
public class Test {
    ...
    static void test0() {
        ...
        for (int i = 0; i < 20; i++) {
        	//System.out.println("realmin " + i + " ours " + fibonacciHeap.findMin().getKey());
            if (fibonacciHeap.findMin().getKey() != i+1) {
                bugFound(test);
                return;
            }
            //System.out.println("Deleteing " + fibonacciHeap.findMin().getKey());
    ...
    static void test16() {
        ...
        if (fibonacciHeap.potential() != 3 ||
        	...
        	System.out.println("total cuts " + FibonacciHeap.totalCuts() + " cuts " + cuts);
        	System.out.println("total links " + FibonacciHeap.totalLinks() + " links " + links);
        	System.out.println("rep " + fibonacciHeap.countersRep()[0]);
        	bugFound(test);
        }
